<!-- Remove This Line If You Want To Add Your Own Custom CSS/Styling To This Page -->
...
<div class="box no-margin no-left-padding col-md-6">
  <h3 class="classic-title2"><span>Flight Plan Options</span></h3>
    ...
    <table class="schedule-briefing">
        ...
        <tr>
            <td>Cont Fuel: </td>
            <td><select class="dispinput" name="contpct">
        ...
        <tr>
            <td>Reserve Fuel: </td>
            <td><select class="dispinput" name="resvrule">
        ...
        <tr>
            <td>Flight Maps: </td>
            <td><select class="dispinput" name="maps">
        ...
        <tr>
            ...
            <td><select class="dispinput" onchange="" name="planformat" id="planformat">
                    ...
                    <option value="ual f:wz">UAL F:WZ</option>
            	</select>
        	</td> 
        </tr>
    </table>
...
<div class="box no-margin no-right-padding col-md-6">
  <h3 class="classic-title4"><span>Route Planner</span></h3>    
    <div class="call-action call-action-boxed call-action-style1 no-descripton clearfix">            
        	...
        	<table class="schedule-briefing">
                <tr>
					<td>
                        ...
                        <img class="routeimg" src="<?php echo fileurl('/lib/images/logos/flightaware.png');?>" alt="Flightaware" title="FlightAware"></a> 
                        ...
                        <img class="routeimg" src="<?php echo fileurl('/lib/images/logos/routes_skv.png');?>" alt="SkyVector" title="SkyVector"></a>
						<a href="http://rfinder.asalink.net/free/" id="rflink" target="_blank">
                        <img class="routeimg" src="<?php echo fileurl('/lib/images/logos/routefinder.png');?>" alt="RouteFinder" title="RouteFinder"></a>
						<a target="_blank" style="cursor:pointer" onclick="validate_cfmu();">
                        <img class="routeimg" src="<?php echo fileurl('/lib/images/logos/euro-ctl.png');?>" alt="CFMU Validation" title="CFMU Validation"></a>
					</td>
                </tr>
				<tr>
    	...
    	<button type="button" style="width:100%" class="btn btn-success btn-lg" onclick="simbriefsubmit('<?php echo SITE_URL; ?>/index.php/SimBrief');" style="font-size:30px" value="Generate">Click to Generate OFP</button>
    </form>
</div>
